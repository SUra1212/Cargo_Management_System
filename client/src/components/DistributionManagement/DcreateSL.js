...
export default class DcreateSL extends Component {
        ...
        this.setState(
            {
                ...
                pno:"0765543108",
                Rname:"Anuruddha Ekanayake",
                RNIC:"975643453V",
                Radd:"Pilimathalawa rd, Kandy",
                city:"Kandy", 
                district:"Kandy",
    ...
    onSubmit = (e) =>{
        ...
        axios.post("/dlankan/save", data).then((res) =>{
            let path = "/DH";
            if(res.data.success){
    ...
    render(){
      ...
      <MDBCardBody>
          <center>
          <MDBCardTitle><center><h2><span class="badge bg-warning text-dark opacity-90">Create New Dispatch Form</span></h2></center></MDBCardTitle>
         <br/>
        </center>
        <MDBCardText>
        <div>
