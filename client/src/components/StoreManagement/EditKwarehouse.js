...
export default class EditKwarehouse extends Component {
    ...
    axios.put(`/koreanWarehouse/update/${id}`,data).then((res) =>{
        let path = "/HKW";
        if(res.data.success){
...
componentDidMount(){
    ...
    axios.get(`/koreanWarehouse/${id}`).then((res) =>{
        if(res.data.success){
            this.setState({
                ...
                receiverContact:res.data.post.receiverContact,
                receiverEmail:res.data.post.receiverEmail,
                receiverAddress:res.data.post.receiverAddress,
                receiverProvince:res.data.post.receiverProvince,
                receiverDistrict:res.data.post.receiverDistrict,
                receiverCity:res.data.post.receiverCity,
                senderName:res.data.post.senderName,
                senderContact:res.data.post.senderContact,
                senderEmail:res.data.post.senderEmail,
                senderAddress:res.data.post.senderAddress,
                senderProvince:res.data.post.senderProvince,
                senderDistrict:res.data.post.senderDistrict,
                senderCity:res.data.post.senderCity,
                pNo:res.data.post.pNo,
                pType:res.data.post.pType,
                pWeight:res.data.post.pWeight,
                pShippingCost:res.data.post.pShippingCost,
    ...
    render(){
        return (
            ...
            <MDBCard  className="opacity-90" style={{ maxWidth: '63rem'}}>
            
            <MDBCardBody >
            
              <MDBCardTitle><center><h1><span class="badge bg-warning text-dark opacity-90">Edit Cargo Information</span></h1></center></MDBCardTitle>
