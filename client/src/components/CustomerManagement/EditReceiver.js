...
export default class EditReceiver extends Component {
    ...
    onSubmit = (e) =>{
        ...
        axios.put(`/receiver/update/${id}`,data).then((res) =>{
            let path = "/Homer";
            if(res.data.success){
    ...
    componentDidMount(){
        ...
        axios.get(`/receiver/${id}`).then((res) =>{
            if(res.data.success){
                this.setState({
                    cfname:res.data.post.cfname,
                    clname:res.data.post.clname,
                    cemail:res.data.post.cemail,
                    cnic:res.data.post.cnic,
                    cphone:res.data.post.cphone,
                    rfname:res.data.post.rfname,
                    rlname:res.data.post.rlname,
                    remail:res.data.post.remail,
                    rnic:res.data.post.rnic,
                    rphone:res.data.post.rphone,
                    raddress:res.data.post.raddress,
                    rsaddress:res.data.post.rsaddress,
                    rcity:res.data.post.rcity,
                    rprovince:res.data.post.rprovince,
        ...
        return (
            ...
            <div className="Kwarehouse">
                ...
                <div style={{ marginLeft: '20%', marginBlockStart: '9%' }}>
                        ...
                        <a href='/Homer' className="btn btn-warning text-dark">Cargo Transport Details</a>
                        <br/>
                        <br/>
                    ...
                    <MDBCard className="opacity-90" style={{ maxWidth: '55rem' }}>
                        ...
                        <MDBCardBody >
                            ...
                            <MDBCardTitle><center><h1><span class="badge bg-warning text-dark opacity-90">Cargo Transport Registration Form</span></h1></center></MDBCardTitle>
