...
export default class PickupRequest extends Component {
                ...
                <div style={{ marginLeft: '20%', marginBlockStart: '9%' }}>
                    ...
                    <MDBCard className="opacity-90" style={{ maxWidth: '55rem' }}>
                        ...
                        <MDBCardBody >
                            ...
                            <MDBCardTitle><center><h1><span class="badge bg-warning text-dark opacity-90">Pickup Request</span></h1></center></MDBCardTitle>
